...
#     url_prefix, url_suffix = ZhiPuModelAPI.split_zhipu_api_url(InvokeType.SYNC, kwargs={"model": "glm-4"})
#     assert url_prefix == "https://open.bigmodel.cn/api"
#     assert url_suffix == "/paas/v4/model-api/chat/invoke"
...
#         InvokeType.SYNC, stream=False, method="get", headers={}, kwargs={"model": "glm-4"}
#     )
